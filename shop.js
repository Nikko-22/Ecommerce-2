  ...
  if (cart.length === 0) {
    ...
    cart.forEach((item, index) => {
      ...
      li.innerHTML = `
        ...
        <button onclick="removeFromCart(${index})" class="remove-button" style="padding:6px 10px; margin:10px 0; background:#808080; border:none; color:#fff; cursor:pointer; transition:background-color 0.3s ease;">Remove</button>
      `;
